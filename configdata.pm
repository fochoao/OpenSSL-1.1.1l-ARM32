...
our %config = (
  ...
  CPPINCLUDES => [  ],
  CXXFLAGS => [  ],
  HASHBANGPERL => "C:\\Perl_x64\\perl\\bin\\perl.exe",
  LD => "link",
  LDFLAGS => [ "/nologo /debug" ],
  LDLIBS => [  ],
  MT => "mt",
  MTFLAGS => [ "-nologo" ],
  PERL => "C:\\Perl_x64\\perl\\bin\\perl.exe",
  RANLIB => "ranlib",
  RC => "rc",
  RCFLAGS => [  ],
  afalgeng => "",
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\10-main.conf", "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\50-win-onecore.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
  ...
  perl_cmd => "C:\\Perl_x64\\perl\\bin\\perl.exe",
  perl_version => "5.32.1",
...
our %target = (
  ...
  MT => "mt",
  MTFLAGS => "-nologo",
  RANLIB => "CODE(0x26ea450)",
  RC => "rc",
  _conf_fname_int => [ "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\10-main.conf", "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\10-main.conf", "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\50-win-onecore.conf", "C:\\cpython\\externals\\openssl-1.1.1l\\Configurations\\shared-info.pl" ],
